  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <ul class="br-menu-sub nav flex-column">
            <li class="nav-item"><a href="accordion.html" class="nav-link">All Orders</a></li>
            <li class="nav-item"><a href="alerts.html" class="nav-link">Inhouse Order</a></li>
            <li class="nav-item"><a href="buttons.html" class="nav-link">Seller Order</a></li>
            <li class="nav-item"><a href="cards.html" class="nav-link">Pick-up Point Order</a></li>
        </ul>
        <a href="#" class="br-menu-link">
          <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{ route('SubCategory') }}" class="nav-link">Sub Categories</a></li>
          <li class="nav-item"><a href="form-layouts.html" class="nav-link">Seller Commission</a></li>
          <li class="nav-item"><a href="form-layouts.html" class="nav-link">Seller Verification Form</a></li>
        </ul>
        <a href="#" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-bookmarks-outline tx-20"></i>
            <span class="menu-item-label">Sales Promotions</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="table-basic.html" class="nav-link">Coupon Lists</a></li>
          <li class="nav-item"><a href="table-basic.html" class="nav-link">Coupon Add</a></li>
          <li class="nav-item"><a href="table-basic.html" class="nav-link">Coupon Edit</a></li>
        </ul>
        <a href="#" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-navigate-outline tx-24"></i>
            <span class="menu-item-label">Blog System</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <ul class="br-menu-sub nav flex-column">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="background.html" class="nav-link">Flash Deals</a></li>
          <li class="nav-item"><a href="border.html" class="nav-link">Newsletters</a></li>
          <li class="nav-item"><a href="height.html" class="nav-link">Subscriber</a></li>
          <li class="nav-item"><a href="height.html" class="nav-link">Coupon</a></li>
        </ul>
        <a href="pages.html" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-paper-outline tx-22"></i>
            <span class="menu-item-label">Uploaded Files</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <a href="#" class="br-menu-link">
            <div class="br-menu-item">
          ...
          <a href="#" class="br-menu-link">
            <div class="br-menu-item">
              <i class="menu-item-icon icon ion-ios-briefcase-outline tx-22"></i>
              <span class="menu-item-label">Setup & Configurations</span>
              <i class="menu-item-arrow fa fa-angle-down"></i>
            </div><!-- menu-item -->
          </a><!-- br-menu-link -->
          <ul class="br-menu-sub nav flex-column">
            <li class="nav-item"><a href="background.html" class="nav-link">General Settings</a></li>
            <li class="nav-item"><a href="border.html" class="nav-link">Features Activation</a></li>
            <li class="nav-item"><a href="height.html" class="nav-link">Language</a></li>
            <li class="nav-item"><a href="height.html" class="nav-link">Currency</a></li>
            <li class="nav-item"><a href="height.html" class="nav-link">Vat & TAX</a></li>
            <li class="nav-item"><a href="height.html" class="nav-link">Pick-up Point</a></li>
            <li class="nav-item"><a href="height.html" class="nav-link">SMTP Settings</a></li>
            <li class="nav-item"><a href="height.html" class="nav-link">Payment Method</a></li>
          </ul>
          <a href="#" class="br-menu-link">
            <div class="br-menu-item">
              <i class="menu-item-icon icon ion-ios-briefcase-outline tx-22"></i>
              <span class="menu-item-label">Staffs</span>
              <i class="menu-item-arrow fa fa-angle-down"></i>
            </div><!-- menu-item -->
          </a><!-- br-menu-link -->
          <ul class="br-menu-sub nav flex-column">
            <li class="nav-item"><a href="background.html" class="nav-link">Users</a></li>
            <li class="nav-item"><a href="border.html" class="nav-link">Border</a></li>
            <li class="nav-item"><a href="height.html" class="nav-link">Height</a></li>
          </ul>
          <a href="#" class="br-menu-link">
            <div class="br-menu-item">
              <i class="menu-item-icon icon ion-ios-briefcase-outline tx-22"></i>
              <span class="menu-item-label">Authentication</span>
              <i class="menu-item-arrow fa fa-angle-down"></i>
            </div><!-- menu-item -->
          </a><!-- br-menu-link -->
          <ul class="br-menu-sub nav flex-column">
            <li class="nav-item"><a href="background.html" class="nav-link">Login</a></li>
            <li class="nav-item"><a href="border.html" class="nav-link">Register</a></li>
            <li class="nav-item"><a href="height.html" class="nav-link">Reset Password</a></li>
            <li class="nav-item"><a href="height.html" class="nav-link">Account Verified</a></li>
          </ul>
        <a href="layouts.html" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-book-outline tx-22"></i>
            <span class="menu-item-label">Addon Manager</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
